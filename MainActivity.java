...
public class MainActivity extends AppCompatActivity {
    ...
    private void chequeaLetra(String letra){
        ...
        for (int i = 0; i < palabraOculta.length(); i++){
            if(palabraOculta.charAt(i) == letra.charAt(0)){
                //quita el guion vajo de la letra correspondiente
        ...
        //chequeo si se ha terminado la partida porque he acertado todas las letras
    ...
    private String escogePalabra(){
        ...
        String[] listaPalabras = {"CETYS","hola", "adios", "cono", "desconozco", "icono", "conocida", "conocimiento", "horas"};
        Random r = new Random();
